...
python test_time.py --cfg cfgs/cifar10_c/ours.yaml Ours.LOSSES ce_s_t1,ce_s_t2,ce_s_aug_t1,contr_t2_proto,mse_t2_proto,contr_t2,im_loss,differ_loss SETTING continual
python test_time.py --cfg cfgs/cifar10_c/ours.yaml Ours.LOSSES ce_s_t1,ce_s_t2,ce_s_aug_t1,contr_t2_proto,mse_t2_proto,contr_t2,im_loss,differ_loss,mem_loss SETTING continual
python test_time.py --cfg cfgs/cifar10_c/ours.yaml Ours.LOSSES ce_s_t1,ce_s_t2,ce_s_aug_t1,contr_t2_proto,mse_t2_proto,contr_t2,im_loss SETTING continual
python test_time.py --cfg cfgs/cifar10_c/ours.yaml Ours.LOSSES ce_s_t1,ce_s_t2,ce_s_aug_t1,contr_t2_proto,mse_t2_proto,contr_t2 SETTING continual
...
python test_time.py --cfg cfgs/cifar100_c/ours.yaml Ours.LOSSES '("ce_s_t1", "ce_s_t2", "ce_s_aug_t1", "contr_t2_proto", "mse_t2_proto", "contr_t2", "im_loss", "differ_loss")' SETTING continual
python test_time.py --cfg cfgs/cifar100_c/ours.yaml Ours.LOSSES '("ce_s_t1", "ce_s_t2", "ce_s_aug_t1", "contr_t2_proto", "mse_t2_proto", "contr_t2", "im_loss", "differ_loss", "mem_loss")' SETTING continual
python test_time.py --cfg cfgs/cifar100_c/ours.yaml Ours.LOSSES '("ce_s_t1", "ce_s_t2", "ce_s_aug_t1", "contr_t2_proto", "mse_t2_proto", "contr_t2", "im_loss")' SETTING continual
python test_time.py --cfg cfgs/cifar100_c/ours.yaml Ours.LOSSES '("ce_s_t1", "ce_s_t2", "ce_s_aug_t1", "contr_t2_proto", "mse_t2_proto", "contr_t2")' SETTING continual
